...
with sync_playwright() as p:
        ...
        stealth_sync(page)
        page.goto('https://www.manta.com/mb_33_C4_000/restaurants_and_bars', user-agent = ua[0])
        st.text(page.title())
        page.goto('https://www.manta.com/c/mms0zjs/lambertville-trading-company', user-agent = ua[1])
        st.text(page.title())
        browser.close()
